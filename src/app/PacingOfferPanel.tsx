 ...
 * (see engine/activation.ts's deriveNextDecisionPoint). Unlike TitrationCheckpointPanel,
 * this is never a clinical decision — no notify-provider branch — so it goes straight to
 * the shared target-dose entry (GuidedLeapTargetForm), prefilled at the next milestone.
 */
